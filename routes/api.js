...
loghandler = {
    ...
    nottext: {
        ...
        creator: `${creator}`,
        code: 406,
        message: 'input text parameters'
    },
    nottext2: {
        status: false,
        creator: `${creator}`,
        code: 406,
        message: 'input parameters text2'
    },
    notnabi: {
        status: false,
        creator: `${creator}`,
        code: 406,
        message: 'input parameters nabi'
    },
    nottext3: {
        status: false,
        creator: `${creator}`,
        code: 406,
        message: 'input parameters text3'
    },
    nottheme: {
        status: false,
        creator: `${creator}`,
        code: 406,
        message: 'input parameters theme'
    },
    notusername: {
        status: false,
        creator: `${creator}`,
        code: 406,
        message: 'input parameters username'
    },
    notvalue: {
        status: false,
        creator: `${creator}`,
        code: 406,
        message: 'input parameters value'
    },
    notheme: {
    	status: false,
        creator: `${creator}`,
    ...
    notAddApiKey: {
        ...
        creator: `${creator}`,
        code: 406,
        message: 'input parameters status, apikeyInput, email, nomorhp, name, age, country, exp'
    },
    error: {
        status: false,
        creator: `${creator}`,
        message: 'maybe repair is being done'
    }
}

const listkey = ["Garioxbot", "gariox"];
...
var len = 15
        ...
        var randomTextNumber = random+randomlagi+'---------Gariox'+'GARIOX--3D';
...
router.get('/cekapikey', async (req, res, next) => {
	...
	json = JSON.stringify({
		...
		message: `dont forget to follow ${creator}`
	})
} else {
	json = JSON.stringify({
		status: false
...
router.get('/addapikey', (req, res, next) => {
    ...
    if (apikey != 'Garioxbot') return res.json(loghandler.invalidKey)
    ...
    try {
        ...
        .then(() => {
              res.json({
                  status: true,
                  creator: `${creator}`,
                  result: 'successfully added data, status : ' + status + ', apikey : ' + apikeyInput + ', email : ' + email + ', nomor_hp : ' + nomorhp + ', name :  ' + name + ', age : ' + age + ', country : ' + country + ', exp : ' + exp
              })
        })
    } catch (e) {
        console.log(e)
    ...
    try {
        ...
        .then(() => {
             res.json({
                  status: true,
                  creator: `${creator}`,
                  result: 'successfully deleted data, status : ' + status + ', apikey : ' + apikeyInput + ', email : ' + email + ', nomor_hp : ' + nomorhp + ', name :  ' + name + ', age : ' + age + ', country : ' + country + ', exp : ' + exp
              })
        })
    } catch (e) {
        console.log(e)
...
router.get('/cewe/vietnam', async (req, res, next) => {
        var apikeyInput = req.query.apikey
	if(!apikeyInput) return res.json(loghandler.notparam)	
	if (apikeyInput != 'Garioxbot')  return res.json(loghandler.invalidKey)
       fetch(encodeURI(`https://raw.githubusercontent.com/zeeoneofc/intake/main/cecan/vietnam.json`))
...
router.get('/cewe/thailand', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)	
	if (apikeyInput != 'Garioxbot')  return res.json(loghandler.invalidKey)
       fetch(encodeURI(`https://raw.githubusercontent.com/zeeoneofc/intake/main/cecan/thailand.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
        var result = data[Math.floor(Math.random() * data.length)];
...
router.get('/cewe/china', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)	
	if (apikeyInput != 'Garioxbot')  return res.json(loghandler.invalidKey)
       fetch(encodeURI(`https://raw.githubusercontent.com/zeeoneofc/intake/main/cecan/china.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
        var result = data[Math.floor(Math.random() * data.length)];
...
router.get('/cewe/indonesia', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)	
	if (apikeyInput != 'Garioxbot')  return res.json(loghandler.invalidKey)
       fetch(encodeURI(`https://raw.githubusercontent.com/zeeoneofc/intake/main/cecan/indonesia.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
        var result = data[Math.floor(Math.random() * data.length)];
...
router.get('/cewe/korea', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)	
	if (apikeyInput != 'Garioxbot')  return res.json(loghandler.invalidKey)
       fetch(encodeURI(`https://raw.githubusercontent.com/zeeoneofc/intake/main/cecan/korea.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
        var result = data[Math.floor(Math.random() * data.length)];
...
router.get('/cewe/japan', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)	
	if (apikeyInput != 'Garioxbot')  return res.json(loghandler.invalidKey)
       fetch(encodeURI(`https://raw.githubusercontent.com/zeeoneofc/intake/main/cecan/japan.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
        var result = data[Math.floor(Math.random() * data.length)];
...
router.get('/cewe/malaysia', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)	
	if (apikeyInput != 'Garioxbot')  return res.json(loghandler.invalidKey)
       fetch(encodeURI(`https://raw.githubusercontent.com/zeeoneofc/intake/main/cecan/malaysia.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
        var result = data[Math.floor(Math.random() * data.length)];
...
//intake
router.get('/intake/cecan', async (req, res, next) => {
        var apikeyInput = req.query.apikey
	if(!apikeyInput) return res.json(loghandler.notparam)	
	if (apikeyInput != 'Garioxbot')  return res.json(loghandler.invalidKey)
...
router.get('/intake/hijaber', async (req, res, next) => {
        var apikeyInput = req.query.apikey
	if(!apikeyInput) return res.json(loghandler.notparam)
	if (apikeyInput != 'Garioxbot')  return res.json(loghandler.invalidKey)
...
router.get('/intake', async (req, res, next) => {
	...
	if (apikeyInput != 'Garioxbot')  return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/binjaicity/warga62/master/intake.js`))
        .then(response => response.json())
        .then(data => {
        var result = data;
        var result = data[Math.floor(Math.random() * data.length)];
...
router.get('/intake/rikagusriani', async (req, res, next) => {
        var apikeyInput = req.query.apikey
            
	if(!apikeyInput) return res.json(loghandler.notparam)
	if (apikeyInput != 'Garioxbot')  return res.json(loghandler.invalidKey)

       fetch(encodeURI(`https://raw.githubusercontent.com/binjaicity/warga62/master/intake/rikagusriani.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
        var result = data[Math.floor(Math.random() * data.length)];
...
router.get('/intake/santuy', async (req, res, next) => {
        var apikeyInput = req.query.apikey
...
router.get('/intake/ukty', async (req, res, next) => {
        var apikeyInput = req.query.apikey
...
router.get('/intake/bocil', async (req, res, next) => {
        var apikeyInput = req.query.apikey
...
router.get('/intake/ghea', async (req, res, next) => {
        var apikeyInput = req.query.apikey
...
router.get('/infonpm', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)
	if(apikeyInput != 'Garioxbot') return res.json(loghandler.invalidKey)
    if (!query) return res.json({ status : false, creator : `${creator}`, message : "input parameters query"})
       ...
       fetch(encodeURI(`https://registry.npmjs.org/${query}`))
        ...
        var result = data;
             res.json({
                 ...
                 creator : `${creator}`,
                 result,
                 message : `do not forget follow ${creator}`
             })
         })
         .catch(e => {
         	res.json(loghandler.error)
...
router.get('/base', async (req, res, next) => {
	var type = req.query.type,
		...
		if (!apikeyInput) return res.json(loghandler.notparam)
		if (apikeyInput != 'Garioxbot') return res.json(loghandler.invalidKey)
		if (!type) return res.json({status: false, creator, code: 404, message: 'input parameters type, type yang tersedia : base64 , base32'})
		if (type == 'base64' && encode){
				...
				res.json({
					status:false,
					creator: `${creator}`,
					message: "add parameters encode/decode"
				})
			} else {
				res.json(loghandler.error)
			}
...
router.get('/nulis', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)
	if(apikeyInput != 'Garioxbot') return res.json(loghandler.invalidKey)
    if (!text) return res.json({ status : false, creator : `${creator}`, message : "input parameters text"})
                                    ...
                                    var urlnya = data.data.url,
                                        ...
                                        res.json({
                                            ...
                                            result:{
                                                ...
                                                info: 'url will disappear after 2 minutes'
                                            }
                                        })
                                })
                        })
...
router.get('/hadits', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)
	if(apikeyInput != 'Garioxbot') return res.json(loghandler.invalidKey)
    if (!kitab) return res.json({ status : false, creator : `${creator}`, message : "input parameters kitab"})
    if (!nomor) return res.json({ status : false, creator : `${creator}`, message : "input parameters nomor"})
...
router.get('/quran', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)
	if(apikeyInput != 'Garioxbot') return res.json(loghandler.invalidKey)
    if (!surah) return res.json({ status : false, creator : `${creator}`, message : "input parameters surah"})
    if (!ayat) return res.json({ status : false, creator : `${creator}`, message : "input parameters ayat"})
...
router.get('/fbdown', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)
	if(apikeyInput != 'Garioxbot') return res.json(loghandler.invalidKey)
    if (!url) return res.json({ status : false, creator : `${creator}`, message : "input parameters url"})
...
router.get('/wikipedia', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)
	if(apikeyInput != 'Garioxbot') return res.json(loghandler.invalidKey)
        if(!search) return res.json({ status : false, creator : `${creator}`, message : "input parameters search"})
...
router.get('/jadwalshalat', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)
	if(apikeyInput != 'Garioxbot') return res.json(loghandler.invalidKey)
        if(!kota) return res.json({ status : false, creator : `${creator}`, message : "input parameters kota"})
...
router.get('/fakedata', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)
	if(apikeyInput != 'Garioxbot') return res.json(loghandler.invalidKey)
        if(!country) return res.json({ status : false, creator : `${creator}`, message : "input parameters country"})
...
router.get('/hilih', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)
	if(apikeyInput != 'Garioxbot') return res.json(loghandler.invalidKey)
        if(!kata) return res.json({ status : false, creator : `${creator}`, message : "input parameters kata"})
...
router.get('/liriklagu', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)
	if(apikeyInput != 'Garioxbot') return res.json(loghandler.invalidKey)
        if(!lagu) return res.json({ status : false, creator : `${creator}`, message : "input parameters kata"})
...
router.get('/infocuaca', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)
	if(apikeyInput != 'Garioxbot') return res.json(loghandler.invalidKey)
	if(!provinsi) return res.json({ status : false, creator : `${creator}`, message : "input parameters provinsi"})
...
router.get('/news/cnn', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)
	if(apikeyInput != 'Garioxbot') return res.json(loghandler.invalidKey)
    if (!type) return res.json({ status : false, creator : `${creator}`, message : "input parameters type"})
...
router.get('/filmapik/search', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)
	if(apikeyInput != 'Garioxbot') return res.json(loghandler.invalidKey)
    if (!film) return res.json({ status : false, creator : `${creator}`, message : "input parameters film"})
...
router.get('/filmapik/play', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)
	if(apikeyInput != 'Garioxbot') return res.json(loghandler.invalidKey)
    if (!id) return res.json({ status : false, creator : `${creator}`, message : "input parameters id"})
...
router.get('/lk21/year', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)
	if(apikeyInput != 'Garioxbot') return res.json(loghandler.invalidKey)
    if (!tahun) return res.json({ status : false, creator : `${creator}`, message : "input parameters tahun"})
...
router.get('/lk21/country', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)
	if(apikeyInput != 'Garioxbot') return res.json(loghandler.invalidKey)
    if (!negara) return res.json({ status : false, creator : `${creator}`, message : "input parameters negara"})
...
router.get('/lk21/genre', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)
	if(apikeyInput != 'Garioxbot') return res.json(loghandler.invalidKey)
    if (!tipe) return res.json({ status : false, creator : `${creator}`, message : "input parameters tipe"})
...
router.get('/ig/stalk', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)
	if(apikeyInput != 'Garioxbot') return res.json(loghandler.invalidKey)
    if (!username) return res.json({ status : false, creator : `${creator}`, message : "input parameters username"})
...
router.get('/yutub/search', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)
	if(apikeyInput != 'Garioxbot') return res.json(loghandler.invalidKey)
    if (!video) return res.json({ status : false, creator : `${creator}`, message : "input parameters video"})
